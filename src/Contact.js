...
function Contact() {
  ...
  return (
    ...
    <h2 className='text-3xl  sm:text-5xl flex gap-2 justify-center pb-10 xs:text-4xl xs:justify-center xs:text-center'><h2 className='text-[#90CCF3] xs:text-4xl sm:text-5xl md:text-5xl'> Contact</h2>Me</h2>
